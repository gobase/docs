...
### パス
```
GET /v1/nft/publisher/{address}/bundles
```
...
例：
```sh
/v1/nft/publisher/{address}/bundles?page=1&per_page=10&status=1,4&owner=0x12345...
```
...
https://api.gobase.io/v1/nft/publisher/{address}/bundles?page=1&per_page=10&status=1,4&owner=0x12345..
```
